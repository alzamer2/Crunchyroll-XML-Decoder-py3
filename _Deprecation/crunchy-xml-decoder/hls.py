...
class resumable_fetch:
    ...
    def read(self, n):
        ...
        if total_size_s_ == 'C.Size':
            progress_bar_print[0] = progress_bar_(download_size_1,download_size_1+1,size_adj(download_size_1, 'harddisk'),'    @ ' + str(size_adj(download_size_1/(time.clock()-start_t), 'internet')),text_end_lenght=17,center_bgc='')
        else:
            progress_bar_print[0] = progress_bar_(download_size_1,total_size,size_adj(download_size_1, 'harddisk')+'/'+size_adj(total_size, 'harddisk'),'%'+str(round(download_size_1 * 100 / total_size)) + ' @ ' + str(size_adj(download_size_1/(time.clock()-start_t), 'internet')),text_end_lenght=17)
